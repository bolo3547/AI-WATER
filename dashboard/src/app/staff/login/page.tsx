      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1">LWSC Staff Portal</h1>
            <p className="text-blue-200/80 text-xs sm:text-sm">Lusaka Water & Sewerage Company</p>
            <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-amber-500/20 rounded-full border border-amber-400/30">
              <AlertTriangle className="w-3 h-3 text-amber-400" />
              <p className="text-amber-300 text-[10px] sm:text-xs font-medium">Authorized Personnel Only</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-6 sm:p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-center gap-2 mb-5 sm:mb-6">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/30 rounded-full">
                ...
                <span className="text-xs font-semibold text-emerald-400">Back-Office Portal</span>
            ...
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-slate-300 mb-2">Employee ID / Username</label>
            ...
            <div className="mt-5 sm:mt-6 pt-4 sm:pt-5 border-t border-white/10">
              <div className="grid grid-cols-3 gap-2 text-center">
                ...
                <div className="flex flex-col items-center gap-1">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                  <span className="text-[9px] sm:text-[10px] text-slate-400">Audit Logged</span>
                </div>
                <div className="flex flex-col items-center gap-1">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400" />
          ...
          <div className="mt-4 p-3 bg-white/5 rounded-xl border border-white/10">
            <p className="text-[10px] sm:text-xs text-slate-400 text-center">
              <span className="font-medium text-slate-300">IT Helpdesk:</span> +260 211 250 155 | ithelpdesk@lwsc.com.zm
            </p>
          </div>
          ...
          <div className="text-center mt-4 sm:mt-6 space-y-1.5 sm:space-y-2">
            <p className="text-slate-400 text-[10px] sm:text-xs">
              © 2026 Lusaka Water & Sewerage Company. Internal Use Only.
            </p>
            <p className="text-red-400/70 text-[9px] sm:text-[10px] font-medium">
